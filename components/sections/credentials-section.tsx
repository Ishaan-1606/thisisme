  ...
  return (
    <div className="w-10 h-10 rounded-lg bg-[#24292F] flex items-center justify-center">
      <svg viewBox="0 0 24 24" width="20" height="20" fill="white">
        <path d="M12 0C5.373 0 0 5.373 0 12c0 6.627 5.373 12 12 12s12-5.373 12-12S18.627 0 12 0zm0 22c-5.523 0-10-4.477-10-10S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm3.938-10.5H12.5v3.5h3.438V12zm0-5H12.5v3.438h3.438V6.5z"/>
      </svg>
    </div>
  )
}
